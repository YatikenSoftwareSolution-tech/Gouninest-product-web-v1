                  ...
                  selectedProperty.images.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute top-1/2 left-3 transform -translate-y-1/2 bg-white/80 rounded-full p-2 hover:bg-white"
                      ...
                      <button
                        ...
                        className="absolute top-1/2 right-3 transform -translate-y-1/2 bg-white/80 rounded-full p-2 hover:bg-white"
