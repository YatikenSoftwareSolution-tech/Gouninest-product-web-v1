...
const SearchedProperties = ({properties, filterData}) => {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our verified student accommodations across top university cities in the UK, Australia, and the USA.  
Each listing is curated to ensure affordability, accessibility, and comfort, no matter where you&apos;re headed.
            </p>
          </div>
