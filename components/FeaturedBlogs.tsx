  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-5xl max-w-4xl mx-auto mb-2 font-bold bg-gradient-to-r from-[var(--color-electric-500)] to-lime-500 bg-clip-text text-transparent">
          {post.title}
        </h2>
        <div className="relative max-w-6xl mx-auto px-2 sm:px-6 lg:px-12 flex flex-col-reverse md:flex-row items-center gap-8 md:gap-0">
          <div className="w-full md:w-1/2 px-0 md:px-6 text-left animate-fade-in">
            ...
            <button
              onClick={() => handleSelectedBlog(post.id)}
              className="mt-6 cursor-pointer flex items-center gap-2 font-medium text-base bg-gradient-to-r from-[var(--color-electric-500)] to-amber-500 text-white py-2 px-4 rounded-full hover:shadow-lg transition-all duration-300"
            >
              Read More
