...
const PropertyTabs = ({countryProperty}: PropertyTabsProps) => {
  return (
    <section
        id="properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Tabs defaultValue="GB" className="w-full flex flex-col gap-6">
            <TabsList className="mb-12 xl:mb-6 flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-6">
              {Array.isArray(countryProperty) && countryProperty.map((country) => (
                <TabsTrigger
                  key={country!.country}
            ...
            {Array.isArray(countryProperty) && countryProperty.map((item) => (
