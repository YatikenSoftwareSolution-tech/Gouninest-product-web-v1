...
const PropertyTabs = () => {
  ...
  return (
      // <section id="properties" className="py-20 bg-gradient-to-br from-[var(--color-electric-50)] to-lime-50">
      ...
      //         Discover best properties near top universities in UK, Australia
      //         and USA. <br /> Each property offers unique experiences and
      //         opportunities for your education journey.
      //       </p>
      //     </div>
      //     <Tabs defaultValue="uk" className="w-full flex flex-col gap-6">
      ...
      //           >
      //             <Image
      //               src={`/${property.country}/flag.jpg`}
      //               alt={property.country}
      //               height={40}
      //               width={40}
      //             />
      //             {property.country}
